...
public class FoldingCellListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        //nếu ô tồn tại - sử dụng lại, nếu không - tạo ô mới
        ...
        if (cell == null) {
            ...
            // cho ô hiện có thiết lập trạng thái hợp lệ  (không có animation)
        ...
        //liên kết dữ liệu từ phần tử được chọn để xem thông quaview holder
        ...
        // tùy chỉnh cho mục danh sách
        if (item.getRequestBtnClickListener() != null) {
            viewHolder.contentRequestBtn.setOnClickListener(item.getRequestBtnClickListener());
        } else {
            // (optionally) thêm trình xử lý "mặc định" nếu không tìm thấy trình xử lý trong mục
