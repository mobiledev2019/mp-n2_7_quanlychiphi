...
public class Overview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restoredBaseString != null) {
            baseString = prefs.getString("base", "CAD");//"Không có tên được xác định "là giá trị mặc định.
                    ...
                    .listener(new OnBMClickListener() {
                        ...
                        public void onBoomButtonClick(int index) {
                            if (index == 1) {
                                ...
                                Toasty.success(getApplicationContext(), "Đăng xuất thành công!!.").show();
    ...
    class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        DialogPlus dialog = DialogPlus.newDialog(Overview.this)
                    ...
                    public void onClick(DialogPlus dialog, View view) {
                        switch (view.getId()) {
                            case R.id.submitButton:
                                ...
                                // TÌM HIỂU NHỮNG GÌ KHI GỬI BUG CỦA DATEPICKER
                ...
                .setExpanded(true, (int)(height / 2.2))  //Điều này sẽ cho phép tính năng mở rộng, (tương tự như hộp thoại chia sẻ Android L)
...
//        graphFragment.updateBarChart();
    ...
    private void showUpdateDialog() {
        //xây dựng dialog với custom layout
